...
<html>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=0.0, maximum-scale=1, user-scalable=no">
<title>PS4 Offline 9.00 Host! V:1.6 By Ali Madhi</title>
<head>
<style>
body{background-color:#2e8b57;color:white;font-size:25px;text-align:center;margin:0;}
button{width:fixed;margin:3px 0px 0px 0px;padding:0px;border:2px solid #fbff00;text-align:center;color:white;outline:none;background:#9acd32;}
button:hover {background: transparent;cursor: pointer;}
.butIMG{display:inline-block;margin:2px;border-bottom:3px solid #839ACA;outline:none;cursor:pointer;}
.butIMG img{width:80px;height:80px;padding:fixed;cursor:pointer;}
.butIMG2{display:inline-block;margin:2px;border-bottom:3px solid red;outline:none;cursor:pointer;}
.butIMG2 img{width:80px;height:80px;padding:fixed;cursor:pointer;}
.butTXT{float:bottom;text-align:center;width:80px;height:40px;font-size:15px;margin:fixed;cursor:pointer;}

footer {position:center;bottom:10px;font-size:16px;font-weight:bold;z-index:1;color:black;text-align:center;text-align:center;font-weight:bold;}
/*
.linear-wipe {text-align: center;background: linear-gradient(to right, rgb(0,0,0) 20%, rgb(255,0,0) 40%, rgb(0,255,0) 60%, #FFF 80%);background-size: 20% auto;color: #000;background-clip: text;
...
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading GoldHEN v2.4b13 Please wait!!!</h1>";
LoadedMSG="GoldHEN v2.4b13 Loaded";
PLfile ="pl_Goldhen24b13.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
function load_disdex(){
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading Enable-Dex. Please wait!</h1>";
LoadedMSG="ToDex Disable";
PLfile = "pl_DEXdisable.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading Copy Cheats. Please wait!</h1>";
LoadedMSG="Copy Cheats Loaded";
PLfile = "pl_CopyCH.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading GTAV Menu 1.0. Please wait!</h1>";
LoadedMSG="GTAV Menu 1.0 Loaded";
PLfile = "pl_gtava1.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading GTAV Menu 1.33. Please wait!</h1>";
LoadedMSG="GTAV Menu 1.33 Loaded";
PLfile = "pl_gtava3.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading RDR2 Menu 1.0. Please wait!</h1>";
LoadedMSG="RDR2 Menu 1.0 Loaded";
PLfile = "pl_Oysters1.00.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading RDR2 Menu 1.24. Please wait!</h1>";
LoadedMSG="RDR2 Menu 1.24 Loaded";
PLfile = "pl_Oysters1.24.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
function load_fancontrol60(){
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading Control Set Temp 60c. Please wait!</h1>";
LoadedMSG="Control Temp 60c Loaded";
PLfile = "fan-threshold60.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
function load_fancontrol65(){
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading Control Set Temp 65c. Please wait!</h1>";
LoadedMSG="Control Temp 65c Loaded";
PLfile = "fan-threshold65.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
function load_fancontrol70(){
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading Control Set Temp 70c. Please wait!</h1>";
LoadedMSG="Control Temp 70c Loaded";
PLfile = "fan-threshold70.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
function load_fancontrol75(){
msgs.innerHTML="<h1 style='font-size:25px;text-align:center;'>Loading Control Set Temp 75c. Please wait!</h1>";
LoadedMSG="Control Temp 75c Loaded";
PLfile = "fan-threshold75.bin";
if (sessionStorage.isbinserver == "no")
{
    loadPayloadData();
}
...
<h1 id=msgs style='font-size:25px;text-align:center;color:white'>PS4 Offline 9.00 Host! V:1.6 By Ali Madhi</h1>
<hr>
<button onclick="load_goldhen24b13(); return false" onmouseover="msgs.innerHTML='GoldHEN v2.4b13'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG2><img src="hen.png"></div><div class=butTXT>GoldHEN v2.4b13</div></button>
<hr>
<button onclick="load_app2usb(); return false" onmouseover="msgs.innerHTML='App2USB'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="app2usb.png"></div><div class=butTXT>App2USB</div></button>
<button onclick="load_dumper(); return false" onmouseover="msgs.innerHTML='Game Dumper'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="dumper.png"></div><div class=butTXT>Game Dumper</div></button>
<button onclick="load_disableupdates(); return false" onmouseover="msgs.innerHTML='Disable Updates v1.0'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="UpdatesDisable.png"></div><div class=butTXT>Disable Updates</div></button>
<button onclick="load_enableupdates(); return false" onmouseover="msgs.innerHTML='Enable Updates v1.0'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="UpdatesEnable.png"></div><div class=butTXT>Enable Updates</div></button>
<button onclick="load_backup(); return false" onmouseover="msgs.innerHTML='Database Backup v1.0'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="dbbackup.png"></div><div class=butTXT>Database Backup</div></button>
<button onclick="load_restore(); return false" onmouseover="msgs.innerHTML='Database Restore v1.0'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="dbrestore.png"></div><div class=butTXT>Database Restore</div></button>
<button onclick="load_orbistoolbox(); return false" onmouseover="msgs.innerHTML='Orbis Tool box'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="OrbisToolbox.png"></div><div class=butTXT>Orbis Tool Box</div></button>
<button onclick="load_todex(); return false" onmouseover="msgs.innerHTML='Enable DEX v1.0 '" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="DEXenable.png"></div><div class=butTXT>Enable DEX</div></button>
<button onclick="load_disdex(); return false" onmouseover="msgs.innerHTML='Disable DEX v1.0'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="DEXdisable.png"></div><div class=butTXT>Disable DEX</div></button>
<button onclick="load_binserver9020(); return false" onmouseover="msgs.innerHTML='BinLoader [Port 9020]'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="binloader.png"></div><div class=butTXT>BinLoader 9020</div></button>
<button onclick="load_exitidu(); return false" onmouseover="msgs.innerHTML='Exit IDU'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="exit.png"></div><div class=butTXT>Exit IDU</div></button>
<button onclick="load_webrte(); return false" onmouseover="msgs.innerHTML='WebRTE (PS4 Trainer Payload)'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="WebRTE.png"></div><div class=butTXT>WebRTE</div></button>
<button onclick="load_CopyCH(); return false" onmouseover="msgs.innerHTML='Copy Cheats'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="ps4trainer.png"></div><div class=butTXT>Copy Cheats</div></button>
<hr>
<button onclick="load_GTAAr1(); return false" onmouseover="msgs.innerHTML='GTAV Mod Menu V1.27'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="gtav.png"></div><div class=butTXT>GTAV Mod Menu 1.27</div></button>
<button onclick="load_GTAAr3(); return false" onmouseover="msgs.innerHTML='GTAV Mod Menu V1.33'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="gtav.png"></div><div class=butTXT>GTAV Mod Menu 1.33</div></button>
<button onclick="load_Oysters100(); return false" onmouseover="msgs.innerHTML='RDR2 Mod Menu V1.0'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="rdr2.png"></div><div class=butTXT>RDR2 Mod Menu 1.0</div></button>
<button onclick="load_Oysters124(); return false" onmouseover="msgs.innerHTML='RDR2 Mod Menu V1.24'" onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'">
<div class=butIMG><img src="rdr2.png"></div><div class=butTXT>RDR2 Mod Menu 1.24</div></button>
<hr>
<div style="font-size:25px;color:white">&nbsp;&nbsp;&nbsp;&nbsp;Set Fan Treshold default is 79°C&nbsp;
<a href="#" class="button pointer" onMouseOver="msgs.innerHTML='Fan Control Set Temp 60c'"; onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'"; onclick="load_fancontrol60(); return false" style="text-align:center;color:lawngreen">60c</a>&nbsp;&nbsp;
<a href="#" class="button pointer" onMouseOver="msgs.innerHTML='Fan Control Set Temp 65c'"; onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'"; onclick="load_fancontrol65(); return false" style="text-align:center;color:lawngreen">65c</a>&nbsp;&nbsp;
<a href="#" class="button pointer" onMouseOver="msgs.innerHTML='Fan Control Set Temp 70c'"; onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'"; onclick="load_fancontrol70(); return false" style="text-align:center;color:lawngreen">70c</a>&nbsp;&nbsp;
<a href="#" class="button pointer" onMouseOver="msgs.innerHTML='Fan Control Set Temp 75c'"; onmouseout="msgs.innerHTML='PS4 Offline 9.00 Host! V:1.6 By Ali Madhi'"; onclick="load_fancontrol75(); return false" style="text-align:center;color:lawngreen">75c</a>&nbsp;&nbsp;
 </div>
<hr>
<footer><div ><h2 class="linear-wipe">الشرق لتجارة الوسائل الترفيهية - عالم الغد علي ماضي - 2023</h2></div></footer>
    <script>
...
{
setTimeout(loadPayloadData(),500);
jbdone();
}
else if(sessionStorage.islinux == "yes")
{
setTimeout(loadPayloadDataSleirs(PLfile),500);
jbdone();
}
else if(sessionStorage.isnetcat == "yes")
{
setTimeout(exec_binserver9020(),500);
}
}
...
var trigger_spray = function () {
    ...
    chain.run();
    //Trigger OOB
    alert("\n                       Insert the USB drive now.\n   Click OK when you see the 'USB unsupported' popup notification.\n                            تنبيه أدخل الفلاش الآن \n               غير مدعوم USB انقر فوق 'موافق' عندما ترى الإشعار المنبثق   \n                     ⚠️ تذكر فصل الفلاش عند اكتمال التهكير ⚠️ ");
    ...
    if (chain.syscall(23, 0).low == 0) { //Exploit Success :P
        ...
        chain.run();
		setTimeout(1000);
         alert("   Remove the flash and Click OK To Continue \n              افصل الفلاش واضغط موافق");
         return;
    }
    //Exploit Failed :(
